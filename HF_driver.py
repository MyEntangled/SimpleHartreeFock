...
def HF_H2_molecule(basis_set, distance_ls):
    ...
    assert basis_set in ['STO-3G', '6-31G'], "Basis set must be either STO-3G or 6-31G!"
    ...
    plot_chart(distance_ls, energy_ls, basis_set)
